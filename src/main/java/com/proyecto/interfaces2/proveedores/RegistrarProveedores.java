...
public class RegistrarProveedores extends javax.swing.JFrame {
    ...
    public RegistrarProveedores(Usuario u){
        this.usuario=u;
        initComponents();
    ...
    private void initComponents() {
        ...
        registro1.setText("Registrar Proveedores");
        LEFT.add(registro1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 70, 280, 50));
        ...
        LEFT.add(txtNombreP, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 180, 320, 30));
        ...
        LEFT.add(txtTelP, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 270, 320, 30));
        ...
        LEFT.add(txtDireccionP, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 360, 320, 30));
        ...
        btnAceptarP.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                numTelefono= Integer.parseInt(txtTelP.getText());
                nit =txtNit.getText();
                if(nombre.length()!=0 && direccion.length()!=0 && txtTelP.getText().length()!=0 && txtNit.getText().length()!=0){
                    Proveedor proveedor = new Proveedor(nombre, direccion, numTelefono, nit);
                    ProveedorDAO proveedorDAO = new ProveedorDAO();
                    proveedorDAO.guardar(proveedor);
                    showMessageDialog(null, "Se a guardado con exito");
                    txtDireccionP.setText("");
                    txtNit.setText("");
                    txtNombreP.setText("");
                    txtTelP.setText("");
                }else{
                    showMessageDialog(null, "Ingrese Valores correctos");
                }
        ...
        LEFT.add(fondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -20, 450, 620));
    ...
    private void btnSalirPMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSalirPMouseClicked
       VerProveedores m = new VerProveedores(usuario);
       m.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrarProveedores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
